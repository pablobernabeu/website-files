...
recent_work:
  ...
  - job: '[Postdoctoral fellowship](https://en.uit.no/go/target/789811)'
    ...
    extra2: '-&nbsp; Service: peer-review for Cognition and Cognitive Science; facilitation of AcqVA Aurora seminars.'
...
I am also interested in other topics, such as the origins and evolution of language, the relationship between language and other cognitive domains, and the understanding of meaning through language. Throughout my research, I have used methods such as behavioural and electroencephalographic experiments, corpus analysis, statistics and programming.

The materials from my research are available at [https://osf.io/25u3x](https://osf.io/25u3x). My CV is [available here](/cv.html).
