...
A significant hurdle with generative AI models like Whisper is their tendency to produce spurious repetitions—a form of hallucination where the model gets "stuck" and repeats phrases.
...
This workflow is made available under the [Creative Commons 4.0 Attribution 4.0 International licence](https://github.com/pablobernabeu/secure_local_HPC_speech_transcription/blob/main/Licence.md). 
...
<div style="text-align: center; margin: 2em 0;">
  <a href="https://github.com/pablobernabeu/secure_local_HPC_speech_transcription" target="_blank" class="github-workflow-button">
