...
categories:
  - viewpoint
tags: [fluke, false positive, false negative, statistics, perception, bias, discrimination]
subtitle: ''
...
The seemingly objective term 'fluke', with its statistical underpinning, seems to be susceptible to biased uses. We may then have to ask: Have other electoral results, comparable to AOC's, been equally studied for signs of a fluke? Why is a certain result perceived as a fluke in the first place? From perceptual to cognitive and historical biases, people's judgements  are susceptible to visual mistakes (Zamboni, Ledgeway, McGraw, & Schluppeck, 2016), confirmation bias (Rajsic, Taylor, & Pratt, 2018) and biased records (Hug, 2003). Incidentally, this holds even in institutions that are relatively regulated, such as higher education and academia (Barber, Hayes, Johnson, Márquez-Magaña, & 10,234 signatories, 2020; Milkman, Akinola, Chugh, 2012, 2015).
