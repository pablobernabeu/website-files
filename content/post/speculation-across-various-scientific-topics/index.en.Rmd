...
For every year, `scopus_compare_topics()` counts the records that match the reference query and those that also match the comparison term. The nine comparisons therefore take `r 9 * 2 * length(unique(readRDS('searches/speculation_comparisons.rds')[[1]]$year))` requests to the Scopus API. Each row of the result holds a year, the count for the reference literature, the count for the comparison and the comparison as a percentage of the reference.
