...
Each panel below shows one literature. The line is the yearly percentage of records that also match `speculat*`, the shaded band is a Wilson interval computed from the yearly reference count, which conveys how much the share would move with a handful of records, and the panels are ordered from the most to the least speculative literature over the whole period. Years in which a literature had no records are left blank.
