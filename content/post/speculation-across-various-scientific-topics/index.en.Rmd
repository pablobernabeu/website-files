...
tags:
  ...
  - research methods
subtitle: ''
summary: 'This reproducible descriptive analysis uses annual Scopus counts to compare how often records in nine query-defined literatures use a form of “speculate” in their titles, abstracts or keywords. The count is a proxy for explicit wording in indexed records, not a measure of evidential quality.'
abstract: 'This descriptive bibliometric analysis compares annual Scopus counts that mention speculat* in the title, abstract or keywords across nine query-defined literatures. It treats the percentage as an indicator of explicit wording in indexed records, not as a direct measure of evidential quality, theoretical progress or the amount of speculation in the full literature, and makes the queries and refreshed data available for inspection.'
authors: []
lastmod: ''
featured: no
draft: no
...
Some research topics invite more explicit conjecture than others. In a review of language evolution, Pieter Vogt and I noted that direct evidence is necessarily limited for many proposed historical processes (Bernabeu & Vogt, 2015). That observation is not an empirical ranking of literatures, and database counts cannot supply one. They can, however, show how often authors use a particular family of words in the title, abstract or keyword fields that Scopus indexes.
...
With those limits in mind, the observed differences describe the wording of these particular queries and records, rather than an ordering of fields by evidence or maturity. Some literatures may use more explicit hedging in abstracts, and query design can change both the numerator and denominator. The data are most useful as a transparent starting point for reading records and revising searches. Anyone who wants to add a topic or inspect a later refresh can dispatch the workflow from the repository.
