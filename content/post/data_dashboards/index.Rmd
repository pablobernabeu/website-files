...
authors: []
tags: [s, data presentation, dashboard, reproducibility, open science, open data, R, R Shiny, Flexdashboard]
...
<div style='font-size:110%;'><b> Dashboards for data visualisation, such as [R Shiny](https://shiny.rstudio.com/) and [Tableau](https://www.tableau.com/), allow the interactive exploration of data by means of drop-down lists and checkboxes, with no coding required from the final users. These web applications can be useful for both the data analyst and the public at large. </b></div>

<div style = "margin-top: 4%;"></div>


<img style = "float: right; margin-left: 30px;" width = "25%" src="https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/1.jpg" alt="OSF repository file listing for the modality switch experiment, with data files in a Dropbox folder" />
...
<img loading="lazy" decoding="async" width = '70%' src='https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/2.png' alt="Graphic titled Online visualisation apps in science, with The Extra Mile logo over an ERP waveform dashboard" />

<img loading="lazy" decoding="async" style = "float: right; margin-left: 30px;" width = '60%' src='https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/3.png' alt="Elsevier author services Data Visualization page encouraging researchers to share their data" />
...
![ERP waveform dashboard for Participant 1, anterior brain area, comparing three context-target conditions](https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/4.png)
...
![ERP waveform dashboard for Participant 7, anterior brain area, showing a noticeably noisier signal](https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/5.png)
...
<img loading="lazy" decoding="async" style = "float: right; margin-left: 30px;" width = '30%' src='https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/6.png' alt="The five file areas of a Shiny app: Data, server, ui, Shiny deployer, and rsconnect folder" />
...
- Data file(s): These are any data files you're using (e.g., with csv or rds extensions).
...
![Google search results for r shiny tutorial, listing video tutorials, blogs and galleries with code](https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/7.png)
...
![OSF server.R script view, with a green arrow looping back to the project's data repository](https://pablobernabeu.github.io/2017/the-case-for-data-dashboards-first-steps-in-r-shiny/8.png)
...
![Animated demo of an interactive R Shiny Flexdashboard responding to user selections](https://raw.githubusercontent.com/pablobernabeu/data-is-present/master/dashboard%20gif.gif)
...
<p>Your browser does not support embedded PDFs. <a href="https://cdn.jsdelivr.net/gh/pablobernabeu/Modality-switch-effects-emerge-early-and-increase-throughout-conceptual-processing@master/ERPs/Plots/List%20plots%20per%20participant%20and%20brain%20area.pdf" target="_blank">Download the PDF</a> instead.</p>
</iframe>
</div>


### Summary in [slides](https://www.slideshare.net/PabloBernabeu/presenting-data-interactively-online-using-r-shiny-126064157)

<iframe title="Slides: The case for data dashboards: First steps in R Shiny" src="//www.slideshare.net/slideshow/embed_code/key/mDJ6IF1RGTiAR8" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe> <div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/PabloBernabeu/presenting-data-interactively-online-using-r-shiny-126064157" title="Presenting data interactively online using R Shiny" target="_blank">Presenting data interactively online using R Shiny</a> </strong> </div>
