...
<img style = "float: right; margin-left: 30px;" width = "25%" src="1.jpg" />
...
<img width = '70%' src='2.png' />

<img style = "float: right; margin-left: 30px;" width = '60%' src='3.png' />
...
<img style = "float: right; margin-left: 30px;" width = '30%' src='6.png' />
