...
National greenhouse-gas figures can be reported as totals, per-capita values, sector compositions or associations with measures of development. These descriptions answer different questions. None, on its own, measures historical responsibility, establishes causation or determines a fair mitigation burden.

This post uses the 2025 Emissions Database for Global Atmospheric Research (EDGAR) report to describe 2024 emissions. EDGAR provides a consistent country-and-sector inventory of fossil CO<sub>2</sub>, CH<sub>4</sub>, N<sub>2</sub>O and fluorinated gases through 2024, excluding land use, land-use change and forestry from the figures used here (Crippa et al., 2025). The analysis combines those estimates with the World Bank income classification and the United Nations Development Programme's Human Development Index (HDI). Its aim is to make the denominators and contextual variables explicit, not to rank countries morally or estimate what any country can afford.

The figures move from totals to per-capita emissions by income group, then to sector composition and a descriptive association with human development. HDI is included as a documented contextual covariate, not as a measure of responsibility or a policy target.
