...
authors: []
tags: [workshop, datathon, data presentation, dashboard, reproducibility, open science, open data, statistics, R, R Shiny, Flexdashboard, HTML, CSS, Software Sustainability Institute Fellowship, N8 CIR]
categories: [R, data presentation, open data]
date: '2020-01-01'
lastmod: ""
featured: true
draft: false
...
| To follow | [Data dashboards and Binder environments](https://github.com/pablobernabeu/Data-is-present/blob/master/N8-CIR-workshops.md/) |  N8 CIR [online] |  |
| To follow | [Introduction to R and R Markdown](https://github.com/pablobernabeu/Data-is-present/blob/master/N8-CIR-workshops.md/) |  N8 CIR [online] |  |
...
df('List of plots per page', width = 13, height = 5)
print(plot1)
print(plot2)
# ...
print(plot150)
