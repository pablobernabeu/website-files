...
- [`scopus_comparison`](https://github.com/pablobernabeu/rscopus_plus/blob/main/scopus_comparison.R) compares counts of publications on various topics during a certain period.
...
First, we'll use the [`scopus_comparison` function](https://github.com/pablobernabeu/rscopus_plus/blob/main/scopus_comparison.R) (fragment shown below).
...
Next, we'll use the [`plot_scopus_comparison` function](https://github.com/pablobernabeu/rscopus_plus/blob/main/plot_scopus_comparison.R) (fragment shown below).
