...
To test these claims, I simulated two data sets. One follows the theory's graph, and the other follows a rival account in which sensorimotor experience also contributes to lexical familiarity, with every other path unchanged. The table below shows how the key claim fares in each.
