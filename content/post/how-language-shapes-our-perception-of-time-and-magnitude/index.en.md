...
tags:
  ...
  - cognitive science
subtitle: ''
summary: 'Languages lay time out along different spatial axes and build number words in different orders. Experiments with speakers of Turkish, Aymara, Mandarin, German and English examine associations between these habits and temporal or numerical tasks. The review finds context-sensitive and developmental effects, not evidence that language rigidly determines thought.'
...
The studies reviewed here are consistent with language contributing to how people represent time and numerical magnitude, alongside cultural, educational and task-specific influences. The evidence is strongest for context-sensitive and developmental associations, not for rigid or uniform effects of one language on thought. Future work should use designs that separate language from correlated social and educational factors, measure individual variation and make crosslinguistic sampling less dependent on a few familiar contrasts.
