...
```{r balance-plot, fig.width = 7.5, fig.height = 3.3, fig.alt = 'Dot-and-whisker plot showing standardised differences and 90 per cent confidence intervals for word length, neighbourhood density and OLD20, with equivalence bounds at minus and plus 0.5'}
