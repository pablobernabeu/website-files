...
<iframe title="Video: Preventing muscle artifacts in electroencephalography sessions" src="https://www.youtube-nocookie.com/embed/9Mbv6bUZlqY" frameborder="0" allowfullscreen
...
<img loading="lazy" decoding="async" src='img/OS verification stage.png' alt='Intervention screen in OpenSesame for experimenter to verify the quality of the electroencephalographic signal' style='margin-top:2px;'></img>
...
<img loading="lazy" decoding="async" src='img/verification stage 2.png' alt='Intervention screen in OpenSesame for experimenter to verify the quality of the electroencephalographic signal' style='margin-top:2px;'></img>
...
<img loading="lazy" decoding="async" src='img/break.png' alt='A buffer period is introduced to best preserve the trials immediately following the breaks' style='margin-top:2px;'></img>
