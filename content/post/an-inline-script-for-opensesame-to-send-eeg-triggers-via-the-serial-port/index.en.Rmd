---
title: An inline script for OpenSesame to send EEG triggers via serial port
author: ''
date: '2023-09-09'
slug: an-inline-script-for-opensesame-to-send-eeg-triggers-via-serial-port
categories:
  - research methods
tags:
...
<script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Fpablobernabeu%2FEEG-tools-and-tips%2Fblob%2Fmain%2FOpenSesame_inline_script_to_send_EEG_triggers_via_serial_port%23L12-L300&style=default&type=code&showLineNumbers=on&showFileMeta=on&showCopy=on"></script>
