...
For the following demo, we'll use an [example file with numbered trials](https://github.com/pablobernabeu/EEG-tools-and-tips/blob/main/example_numbered_trials.vmrk).
