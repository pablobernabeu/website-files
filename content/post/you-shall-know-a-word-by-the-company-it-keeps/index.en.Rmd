...
Distributional models can also track sensorimotor properties of concepts ([Bernabeu, 2022](https://doi.org/10.17635/lancaster/thesis/1795); [Louwerse, 2011](https://doi.org/10.1111/j.1756-8765.2010.01106.x); [Louwerse & Connell, 2011](https://doi.org/10.1111/j.1551-6709.2010.01157.x)), though unaided text captures only part of the picture – grounding sensorimotor features more fully may require fine-tuning on human ratings ([Wu et al., 2026](https://doi.org/10.48550/arXiv.2603.03313)) or other forms of supervision ([Xu et al., 2025](https://doi.org/10.1038/s41562-025-02203-8)). Language, then, does not merely label the world – it encodes its structure, and even a simple co-occurrence model can read much of that encoding back.
...
lsa_pipeline <- function(doc_list, labels, grp_a, grp_b,
  ...
  # the traces present. It fetches that build from the plotly CDN, so it needs
  # network access at render time.
  pp <- partial_bundle(pp)
...
Günther, F., Dudschig, C., & Kaup, B. (2016). LSAfun: An R package for computations based on Latent Semantic Analysis. *Behavior Research Methods, 48*(2), 409-421. https://doi.org/10.3758/s13428-014-0529-0
