...
The second corpus moves from newswire to politics. The `sotu` package provides the full text of every US State of the Union address from 1790 to 2020. Splitting the addresses at 1945, the end of the Second World War, shows how American political vocabulary has shifted from the constitutional and agrarian language of the early republic to the geopolitical and welfare-state vocabulary of the modern era. Table 2 and Figure 2 present the results.
...
Lin, S., Hilton, J., & Evans, O. (2022). TruthfulQA: Measuring how models mimic human falsehoods. In *Proceedings of the 60th Annual Meeting of the Association for Computational Linguistics* (pp. 3214–3252). Association for Computational Linguistics. https://doi.org/10.18653/v1/2022.acl-long.229
