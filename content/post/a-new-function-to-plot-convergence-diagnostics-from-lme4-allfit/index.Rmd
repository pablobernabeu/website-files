...
Below is the new `plot.fixef.allFit` function (of course it could be given any other name). The function can be copied by clicking on the button at the top right corner. 
...
```{r demo-plot.fixef.allFit-function, fig.dim = c(9, 7)}
...
The output of the function is a [ggplot2](https://ggplot2.tidyverse.org/) plot, which can be stored into an object for further use, as in the following example.
