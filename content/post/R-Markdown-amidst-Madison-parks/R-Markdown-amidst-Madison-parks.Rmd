...
subtitle: "<span style='font-size:18px'> - <a href='https://data-cityofmadison.opendata.arcgis.com/datasets/parks'> City of Madison data </a> <br> - <a href='https://github.com/pablobernabeu/Data-is-present/blob/master/examples-documents-dashboards/R%20Markdown/R-Markdown-amidst-Madison-parks.Rmd' target='_top'> Code  </a> </span>"
slug: R-Markdown-amidst-Madison-parks
plotly: true   # Enable plotly graphs (https://github.com/wowchemy/wowchemy-hugo-themes/issues/1673#issuecomment-647340415)
categories:
  - programming
  - R
tags:
  ...
  - cross-references
date: '2020-08-14'
summary: "This document is part of teaching materials created for the workshop 'Open data and reproducibility v2.1: R Markdown, dashboards and Binder', delivered at the CarpentryCon 2020 conference. The purpose of this specific document is to practise R Markdown, including basic features such as Markdown markup and code chunks, along with more special features such as cross-references for figures, tables, code chunks, etc. Since this conference was originally going to take place in Madison, let's look at some open data from the City of Madison."
authors: []
featured: no
image:
  caption: ''
...
We could decide to display the code for the table at this point (or any other), which can be done using the parameters `ref.label = 'largest-parks', echo = TRUE, eval = FALSE` in the chunk options ([Xie, Dervieux, &  Riederer, 2020](https://bookdown.org/yihui/rmarkdown-cookbook/reuse-chunks.html)).

```{r ref.label = 'largest-parks', echo = TRUE, eval = FALSE}
```
