...
tags:
  ...
  - statistics
  - power analysis
event: 'Lancaster University Postgraduate Psychology Conference 2021'
event_url: ~
location: ~
address:
  street: ~
...
authors: ['<span style="font-size:150%;">Pablo Bernabeu, Dermot Lynott and Louise Connell</span>']
featured: no
image:
  caption: ''
  focal_point: ''
...
##### [Slides](/talk/linguistic-and-embodied-systems-in-conceptual-processing-variation-across-individuals-and-items/slides)

```{r embed-xaringan, echo=FALSE}

library(xaringanExtra)

xaringanExtra::embed_xaringan(url = "/talk/linguistic-and-embodied-systems-in-conceptual-processing-variation-across-individuals-and-items/slides", ratio = "4:3")
