...
<div class="mermaid">
graph TD
  A["Conceptual processing"] --> B["Linguistic<br/>distributional<br/>systems"]
  A --> C["Embodied<br/>systems"]
  B --> D["Word<br/>co-occurrence"]
  B --> E["Word<br/>association"]
  C --> F["Sensorimotor<br/>information"]
  C --> G["Emotional<br/>information"]
  H["Calgary Semantic<br/>Decision<br/>project data"] --> I["Confirmatory<br/>research<br/>questions"]
  B --> I
  C --> I
  J["Individual<br/>differences in<br/>vocabulary size"] -->|moderates| I
</div>
```
