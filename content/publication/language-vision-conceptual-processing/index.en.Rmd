...
<div class="mermaid">
graph TD
  A["Three datasets: semantic<br/>priming, semantic<br/>decision, lexical decision"] --> B["Add language-based and<br/>vision-based measures"]
  B --> C["Mixed-effects models<br/>across individuals,<br/>words and tasks"]
  C --> D["Language-based<br/>information more<br/>important than<br/>vision-based"]
  C --> E["Priming: both stronger<br/>when words shown faster"]
  C --> F["Higher-vocabulary readers<br/>show a task-relevance<br/>advantage"]
  C --> G["Power: 300 participants<br/>for language effects;<br/>over 1,000 for<br/>vision effects"]
</div>
```
### Related podcasts
