...
<iframe title="Slides: Unpacking ERP responses in artificial language learning" src="https://www.slideshare.net/slideshow/embed_code/key/FWeoCwR0OycM7m?startSlide=1" width="700" height="394" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px;max-width: 100%;" allowfullscreen></iframe>
...
graph TD
  ...
  C --> H["P600-like effect for misplaced definite<br/>articles, consistent across sessions 2-4<br/>(strongest in medial/posterior regions)"]
  D --> H
  E --> H
