...
authors: ['<span style="font-size:140%;">Pablo Bernabeu, Christina Athanasiadi, Gabriella Silva, Stella Pischinger, My Ngoc Giang Hoang, Vincent DeLuca, Jason Rothman, Claudia Poch, Iva Ivanova, Jorge González Alonso</span>']
author: ~
date: '2025-02-13'
...
<a href='https://mfr.osf.io/render?url=https://osf.io/xevr9/?direct%26mode=render%26action=download%26mode=render'>
      ...
      <span style="color:#DBE6DA;"></span> Full-screen PDF slides </h3></button></a> &nbsp; 

<iframe src="https://www.slideshare.net/slideshow/embed_code/key/fOJAyxOsikHGKz?startSlide=1" width="597" height="486" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px;max-width: 100%;" allowfullscreen></iframe>
