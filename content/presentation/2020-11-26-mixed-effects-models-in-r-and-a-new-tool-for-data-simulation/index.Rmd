...
graph TD
  ...
  H["Also presented, as a separate<br/>topic: web application<br/>for data simulation"]
</div>
```
### Slides &nbsp; [<i class="fas fa-external-link-alt"></i>](https://hackmd.io/@pablobernabeu/SkRyLbaqw)

<iframe title="Slides: Mixed-effects models in R and a new tool for data simulation" width="100%" height="500" src="https://hackmd.io/@pablobernabeu/SkRyLbaqw" frameborder="0" style="padding-top:5px"></iframe>
